...
<?php
    require_once "logic/config.php";    // Initial Connection to DB
    ...
    <div class="container">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-add" role="tabpanel" aria-labelledby="nav-add-tab">
                <br>
                <form action="logic/add_project.php" method="POST" enctype="multipart/form-data">
                ...
                <br>
                <hr class="seperator">
                <form action="logic/create_category.php" method="POST" style="width: 75%; margin: 0 auto;">
                ...
                <script>
                    function setDelete() {
                        if (confirm("Do you want to DELETE this Project(s) and its corresponding data?\n\nWARNING: You will unable to redo this action!")) {
                            document.removeTable.action = "logic/remove_project.php";
            ...
            <div class="tab-pane fade" id="nav-update" role="tabpanel" aria-labelledby="nav-update-tab">
                ...
                <div class="container content-container">
                    <form name="updateProj" method="POST" action="logic/update_project.php" enctype="multipart/form-data">
                        <br>
