<?php
    require_once "scripts/database/config.php"    // Initial Connection to DB
?>
...
<head>
    ...
    <link rel="stylesheet" href="style/museum/css/style.min.css">
    ...
    <div class="verti-spacing">
        ...
        <div class="filterbar">
            <form method="GET" class="list-container">
                ...
                ?>
                    <li class="item-contianer">
                        <button type="submit" name="keywords" value="<?php echo $value['category'] ?>"
                            class="item-action">
...
<script src="scripts/museum/responsive.js"></script>
